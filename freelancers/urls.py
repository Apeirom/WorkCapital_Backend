...
from .views import RegisterView, FreelancerViewSet, UserProfileViewSet, InvestorViewSet, ContractorViewSet, CreditTakerViewSet 

# O 'router.urls' é uma lista, então adicionamos nossa rota customizada
urlpatterns = [
    path('register/', RegisterView.as_view(), name='user_register'), # Ex: /api/v1/register/
] 
